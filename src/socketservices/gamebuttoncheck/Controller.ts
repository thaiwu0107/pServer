...
@provide('GameButtonCheckController')
export default class GameButtonCheckController extends BaseController {
    constructor(@inject('GameButtonCheckServer') private service: Service) {
        super();
    }
    public async on(
        ws: WsEntity,
